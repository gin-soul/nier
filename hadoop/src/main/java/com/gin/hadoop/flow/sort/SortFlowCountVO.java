 ...
 *
 * 需要排序情况下实现 WritableComparable,不需要排序,直接实现 Writable
 *
 */
public class SortFlowCountVO implements WritableComparable<SortFlowCountVO> {
    ...
    @Override
    public int compareTo(SortFlowCountVO other){
        //根据上行流量包进行排序操作
        // * -1 来降序排列
        return this.upFlow.compareTo(other.upFlow) * -1;
    }
